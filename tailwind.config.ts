    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          light: "#8cd4dd",
          /** Ghost blue — top logo layer */
          pale: "#b4e3fa",
          /** Near-white — top logo layer */
          white: "#feffff",
        },

        // ── Arch section tint backgrounds ─────────
        // Used per-card as background transitions
        arch: {
          cloud: "#e8f6fc",
          ai: "#eaf9f9",
          web: "#f0f4ff",
      ...
      fontFamily: {
        ...
        // Montserrat — used in Hero + Arch sections
